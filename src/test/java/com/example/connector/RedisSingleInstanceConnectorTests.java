...
import static com.example.SpringRedisApplication.REDIS_HOST;
import static com.example.SpringRedisApplication.REDIS_PORT;
...
@SpringBootTest(classes = { RedisSingleInstanceConnectorTests.RedisConfiguration.class })
public class RedisSingleInstanceConnectorTests {
  ...
  private final String VALUE = "mayValue";
